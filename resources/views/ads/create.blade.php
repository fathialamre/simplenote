    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 {{ $errors->has('company') ? "has-error": ""}}">
                ...
                {!! Form::text('company','', ['class' => 'form-control', 'placeholder' => 'الشركة' ]) !!}
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 {{ $errors->has('address') ? "has-error": ""}}">
                ...
                {!! Form::text('address','', ['class' => 'form-control', 'placeholder' => 'العنوان' ]) !!}
        ...
        <div class="row">
            <div class="form-group col-md-6 {{ $errors->has('activity') ? "has-error": ""}}">
                ...
                {!! Form::text('activity','', ['class' => 'form-control', 'placeholder' => 'النشاط' ]) !!}
        ...
        <div class="row">
            <div class="form-group col-md-6 {{ $errors->has('price') ? "has-error": ""}}">
                ...
                {!! Form::text('price','', ['class' => 'form-control', 'placeholder' => 'السعر المطلوب' ]) !!}
            ...
            <div class="form-group col-md-6 {{ $errors->has('currency') ? "has-error": ""}}">
                ...
                {{ Form::select('currency', ['دينار ليبي' => 'دينار ليبي', 'دولار امريكي' => 'دولار امريكي'], null, ['class' => 'form-control']) }}
        ...
        <div class="row">
            <div class="form-group col-md-6 {{ $errors->has('des') ? "has-error": ""}}">
                ...
                {!! Form::text('des','', ['class' => 'form-control', 'placeholder' => 'الوصف' ]) !!}
