    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-4 {{ (request()->is('home')) ? 'active' : '' }}" href="{{route('home')}}">الرئيسية</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-4 {{ (request()->is('ads')) ? 'active' : '' }}" href="{{route('ads.index')}}">إعلاناتي</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-3 {{ (request()->is('flowers')) ? 'active' : '' }}" href="{{route('flowers')}}">المتابعون</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-4 {{ (request()->is('seen')) ? 'active' : '' }}" href="{{route('seen')}}">شوهد</a>
                </li>
            </ul>
        </div>
    </div>
